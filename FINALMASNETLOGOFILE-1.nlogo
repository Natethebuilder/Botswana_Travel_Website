...
@#$#@#$#@
<experiments>
  <experiment name="SharedResourceIntensityEffects" repetitions="15" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="150"/>
  ...
  <experiment name="CommunityEventIntensity" repetitions="3" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>coopother-agg</metric>
